...
if (!$category){
    ...
    <div class="list">
        <p class="no_game">Aucun jeu dans le genre {$categoryPage->escapeString($catObject->getDescription())}</p>
    </div>
HTML);
...
$categoryPage->appendContent(<<<HTML
    <div class='header'> 
        ...
        <h1>Jeux vidéo : {$categoryPage->escapeString($catObject->getDescription())}</h1></div> 
        <div class="sort-menu">
